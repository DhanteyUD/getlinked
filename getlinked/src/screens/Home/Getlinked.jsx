			...
			<div className="div">
				{/* <div className="overlap">
					<div className="overlap-group">
						<img
							...
							src="https://c.animaapp.com/zMz5XxGb/img/purple-lens-flare-png.png"
						/>
						<img
							className="metrix"
							alt="Metrix"
							src="https://c.animaapp.com/zMz5XxGb/img/metrix-1.png"
						/>
						<img
							className="img"
							alt="Purple lens flare"
							src="https://c.animaapp.com/zMz5XxGb/img/purple-lens-flare-png-10.png"
						/>
						<img
							className="line"
							alt="Line"
							src="https://c.animaapp.com/zMz5XxGb/img/line-1.svg"
						/>
						<img
							className="line-2"
							alt="Line"
							src="https://c.animaapp.com/zMz5XxGb/img/line-2.svg"
						/>
						<img
							className="line-3"
							alt="Line"
						...
						<img
							className="img-2"
							alt="Getlinked"
							src="https://c.animaapp.com/zMz5XxGb/img/getlinked.svg"
						/>
						<img
							className="man-wearing-smart"
							alt="Man wearing smart"
							src="https://c.animaapp.com/zMz5XxGb/img/man-wearing-smart-glasses-touching-virtual-screen-1.svg"
						/>
						...
						<div className="title">
							<div className="overlap-2">
								<div className="overlap-3">
									<div className="text-wrapper-7">getlinked Tech</div>
									<p className="hackathon">
										<span className="span">Hackathon </span>
										<span className="text-wrapper-8">1.0</span>
									</p>
									<img
										className="creative"
										alt="Creative"
										src="https://c.animaapp.com/zMz5XxGb/img/creative-1.svg"
									/>
								</div>
								<img
									className="chain"
									alt="Chain"
									src="https://c.animaapp.com/zMz5XxGb/img/chain-9365116-7621444.svg"
								/>
							</div>
							<img
								className="element"
								alt="Element"
								src="https://c.animaapp.com/zMz5XxGb/img/1f4a5.svg"
							/>
						</div>
						<img
							className="image"
							alt="Image"
							src="https://c.animaapp.com/zMz5XxGb/img/image-1.svg"
						/>
						...
						<img
							...
							alt="Purple lens flare"
							src="https://c.animaapp.com/zMz5XxGb/img/purple-lens-flare-png-8.svg"
						/>
						<p className="introduction-to">
							...
							<span className="text-wrapper-8">tech Hackathon 1.0</span>
						</p>
						<p className="rules-and-guidelines">
							...
							<span className="text-wrapper-8">Guidelines</span>
						</p>
						...
						<img
							className="arrow"
							alt="Arrow"
							src="https://c.animaapp.com/zMz5XxGb/img/arrow.svg"
						/>
						<img
							className="star"
							alt="Star"
							src="https://c.animaapp.com/zMz5XxGb/img/star-24.svg"
						/>
						<img
							className="star-2"
							alt="Star"
						...
						<img
							className="star-5"
							alt="Star"
							src="https://c.animaapp.com/zMz5XxGb/img/star-20.svg"
						/>
						<img
							className="star-6"
							alt="Star"
						...
						<img
							className="sata-gra"
							alt="Sata gra"
							src="https://c.animaapp.com/zMz5XxGb/img/sata-gra-7.svg"
						/>
						<img
						...
						<img
							className="star-pu"
							alt="Star pu"
							src="https://c.animaapp.com/zMz5XxGb/img/star-pu-6.svg"
						/>
						<img
							className="star-pu-2"
							alt="Star pu"
						...
						<img
							...
							alt="Star outlin"
							src="https://c.animaapp.com/zMz5XxGb/img/star-outlin@2x.png"
						/>
						<img
							className="ellipse"
							alt="Ellipse"
							src="https://c.animaapp.com/zMz5XxGb/img/ellipse-1.svg"
						/>
						<div className="ellipse-2" />
						<img
							className="element-3"
							alt="Element"
							src="https://c.animaapp.com/zMz5XxGb/img/7450159-1.svg"
						/>
						<p className="judging-criteria-key">
							...
							<span className="text-wrapper-8">Key attributes</span>
						</p>
						<p className="frequently-ask">
							...
							<span className="text-wrapper-8">Question</span>
						</p>
						<img
							className="purple-lens-flare-4"
							alt="Purple lens flare"
							src="https://c.animaapp.com/zMz5XxGb/img/purple-lens-flare-png-5.png"
						/>
						<img
							className="purple-lens-flare-5"
							alt="Purple lens flare"
							src="https://c.animaapp.com/zMz5XxGb/img/purple-lens-flare-png-4.png"
						/>
						<img
							className="element-4"
							alt="Element"
							src="https://c.animaapp.com/zMz5XxGb/img/8046554-1.svg"
						/>
						...
						<img
							...
							alt="Cwok casual"
							src="https://c.animaapp.com/zMz5XxGb/img/cwok-casual-21-1.svg"
						/>
						<img
							className="star-9"
							alt="Star"
						...
						<img
							className="img-3"
							alt="Img"
							src="https://c.animaapp.com/zMz5XxGb/img/--1.svg"
						/>
						<img
							className="img-4"
							alt="Img"
							src="https://c.animaapp.com/zMz5XxGb/img/-.svg"
						/>
						...
						<img
							className="vector"
							alt="Vector"
							src="https://c.animaapp.com/zMz5XxGb/img/vector-4.svg"
						/>
					</div>
					<p className="we-got-answers-to">
						...
						<span className="text-wrapper-17">getlinked Hackathon 1.0</span>
					</p>
					<img
						className="star-pu-3"
						alt="Star pu"
					...
					<div className="question-of-FAQ">
						...
						<img
							className="line-4"
							alt="Line"
							src="https://c.animaapp.com/zMz5XxGb/img/line-10-5.svg"
						/>
				...
				{/* <div className="overlap-5">
					<div className="overlap-6">
						...
						<div className="footer-contents">
							<p className="div-2">
								...
								<span className="text-wrapper-8">linked</span>
							</p>
							...
							<div className="overlap-9">
								<div className="useful-links-and">
									...
									<img
										...
										alt="Social media"
										src="https://c.animaapp.com/zMz5XxGb/img/social-media@2x.png"
									/>
								</div>
								<img
									className="group"
						...
						<img
							...
							alt="Purple lens flare"
							src="https://c.animaapp.com/zMz5XxGb/img/purple-lens-flare-png-1.png"
						/>
						...
						<div className="text-wrapper-34">Licensing Policy</div>
						...
						<div className="list-terms">
							<img
								className="vector-3"
								alt="Vector"
								src="https://c.animaapp.com/zMz5XxGb/img/vector-3-1.svg"
							/>
						</div>
						...
						<img
							className="vector-4"
							alt="Vector"
							src="https://c.animaapp.com/zMz5XxGb/img/vector.svg"
						/>
						<img
							className="element-6"
							alt="Element"
					...
					<img
						className="star-pu-6"
						alt="Star pu"
						src="https://c.animaapp.com/zMz5XxGb/img/star-pu@2x.png"
					/>
					<img
						className="star-22"
						alt="Star"
				...
				<div className="overlap-13">
					<div className="timeline">
						...
						<img
							...
							src="https://c.animaapp.com/zMz5XxGb/img/line-4.svg"
						/>
						<div className="text-wrapper-47">Hackathon Announcement</div>
						<div className="text-wrapper-48">Teams Registration ends</div>
						<p className="text-wrapper-49">
							Getlinked Hackathon 1.0 Offically Begins
						</p>
						<div className="text-wrapper-50">Teams Registration begins</div>
						<p className="announcement-of-the">
							Announcement of the accepted teams
							<br />
							and ideas
						</p>
						<div className="text-wrapper-51">Demo Day</div>
						...
						<div className="text-wrapper-52">November 18, 2023</div>
						<div className="text-wrapper-53">November 18, 2023</div>
						...
						<div className="no-6">
							<div className="overlap-group-3">
								<div className="text-wrapper-59">6</div>
							</div>
						</div>
						<img
							className="star-24"
