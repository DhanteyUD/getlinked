	...
	return (
		<>
			<div className="gl_sponsors">
				<div className="gl_sponsors_container">
					<div className="gl_sponsors_top_div">
					...
					<div className="gl_sponsors_bottom_div">
						<img
							className="star-10"
							alt="Star"
